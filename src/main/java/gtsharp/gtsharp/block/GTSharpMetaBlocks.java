...
public class GTSharpMetaBlocks {

    public static GTSharpBlockMultiblockCasing GT_SHARP_BLOCK_MULTIBLOCK_CASING;

    public static void init() {
        GT_SHARP_BLOCK_MULTIBLOCK_CASING = new GTSharpBlockMultiblockCasing();
        GT_SHARP_BLOCK_MULTIBLOCK_CASING.setRegistryName("gtsharp_multiblock_casing");
    }

    @SideOnly(Side.CLIENT)
    public static void registerItemModels() {
        registerItemModel(GT_SHARP_BLOCK_MULTIBLOCK_CASING);
    }
