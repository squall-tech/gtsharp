...
public class InfoFissionReactor extends MultiblockInfoPage {
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        builder.aisle("XXXXX", "XXRXX", "XXXXX", "XXXXX", "XXXXX",  "XXXXX",  "XXXXX")
                ...
                .where('M', GTSharpMetaBlocks.GT_SHARP_BLOCK_MULTIBLOCK_CASING.getState(GTSharpBlockMultiblockCasing.MultiblockCasingType.GRAPHITE_MODERATOR));
